...
const EnglandGallery = () => {
  ...
  const countryText = t.countries.england;
  const galleryTitle = countryText.galleryTitle || "England Photo Gallery";
  const gallerySub =
  ...
  const backToCountry = countryText.backToCountry || "Back to England";
  ...
  const images = import.meta.glob("../england_gallery/*.{jpg,jpeg,png,JPG}", {
    eager: true,
    query: "?url",
    import: "default",
  });
      ...
      <nav className="navbar">
        <div className="nav-content">
          ...
          <div className="nav-links">
            <Link to="/england">{backToCountry}</Link>
      ...
      <main className="container page-content">
        <section className="glass" style={{ padding: "3rem", marginTop: "2rem" }}>
          ...
          <div style={{ marginTop: "3rem" }}>
            <Link to="/england" className="cta-button">
              {backToCountry}
            </Link>
          </div>
        </section>
