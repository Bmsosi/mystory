...
const ScotlandGallery = () => {
  ...
  const countryText = t.countries.scotland;
  const galleryTitle = countryText.galleryTitle || "Scotland Photo Gallery";
  const gallerySub =
    countryText.gallerySub ||
    "A short visual collection from Scotland, from city landmarks to hillside views during my UK travels.";
  const backToCountry = countryText.backToCountry || "Back to Scotland";
  ...
  const images = import.meta.glob("../scotland_gallery/*.{jpg,jpeg,png,JPG}", {
    eager: true,
    query: "?url",
    import: "default",
  });
      ...
      <nav className="navbar">
        <div className="nav-content">
          ...
          <div className="nav-links">
            <Link to="/scotland">{backToCountry}</Link>
      ...
      <main className="container page-content">
        <section className="glass" style={{ padding: "3rem", marginTop: "2rem" }}>
          ...
          <div style={{ marginTop: "3rem" }}>
            <Link to="/scotland" className="cta-button">
              {backToCountry}
            </Link>
          </div>
        </section>
