...
const TanzaniaGallery = () => {
  const { t, language } = useLanguage();
  const galleryTitle = `${t.countries.tanzania.name} Gallery Images`;
      ...
      <nav className="navbar">
        <div className="nav-content">
          ...
          <div className="nav-links">
            <Link to="/tanzania">Back to Tanzania</Link>
      ...
      <main className="container page-content">
        <section className="glass" style={{ padding: "3rem", marginTop: "2rem" }}>
          ...
          <div style={{ marginTop: "3rem" }}>
            <Link to="/tanzania" className="cta-button">
              Back to Tanzania
            </Link>
          </div>
        </section>
...
export default TanzaniaGallery;
